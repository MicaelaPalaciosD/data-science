...
#ATE
#gives us elasticity. average effect across all prod.
#increasing the price (now by not such a big number (before by 65 now by 0.5)) makes it more price sensitive than decreasing the price (another practice I did with -0.5 which changed the lp to -0.596. 
```
