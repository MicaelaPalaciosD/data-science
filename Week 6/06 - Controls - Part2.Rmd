...
head(upc)
dim(upc)
wber$lp <- log(12*(wber$PRICE+65)/upc[wber$UPC,"OZ"]) #ln price per 12 ounces, normalize p to be per 12 ounces I changed price to increase it and see how it affects elasticity
```
